(function($){
	...
	break;
		...
		renderBUTTON="";
		renderBUTTON += '<a href="javascript:void(0);" class="btn btn-lg btn-success form_yes">'+form_settings.yes+'<span></span></a>&nbsp;&nbsp;&nbsp;&nbsp;';
		renderBUTTON += '<a href="javascript:void(0);" class="btn btn-lg btn-danger form_no">'+form_settings.no+'<span></span></a>';
		
		var renderTemplate = [
			'<div id="previewOverlay" class="well">',
			'<div id="previewBox">',
